...
MinecraftHelper.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    var speechText = "Welcome to the Happy Helper. You can ask a question like, what's the recipe for focus? ... Now, what can I help you with.";
...
MinecraftHelper.prototype.intentHandlers = {
    ...
    "AMAZON.StopIntent": function (intent, session, response) {
        var speechOutput = "Goodbye, stay happy.";
    ...
    "AMAZON.HelpIntent": function (intent, session, response) {
        var speechText = "You can ask questions about happiness such as, what's the recipe for focus, or, you can say exit... Now, what can I help you with?";
        var repromptText = "You can say things like, what's the recipe for relaxation, or you can say exit... Now, what can I help you with?";
        var speechOutput = {
            speech: speechText,
            type: AlexaSkill.speechOutputType.PLAIN_TEXT
        };
